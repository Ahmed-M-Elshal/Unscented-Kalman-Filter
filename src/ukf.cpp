...
UKF::UKF() {
  ...
  */
  ...
  // Initialize x and P
  // px and py will be initialized based on sensor measurement
  x_(0) = 0.001; // p_x
  x_(1) = 0.001; // p_y
  x_(2) = 6.28; // Estimated speed of the bicycle
  x_(3) = M_PI / 8; // Estimated yaw
  x_(4) = M_PI / 8; // Estimated yaw rate
  P_ = MatrixXd::Identity(5, 5); // Start with I matrix
  // Update px and py variance to be those of Laser sensor
...
void UKF::ProcessMeasurement(MeasurementPackage meas_package) {
  ...
  */
  ...
  // Check whether the current sensor is supported or not
...
void UKF::Prediction(double delta_t) {
  ...
  */
  ...
  // Step 1: Generate and augment sigma points
